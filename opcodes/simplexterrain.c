...
/*  Wave-terrain synthesis opcode with simplex noise
 *
 */
typedef struct {
...
static Grad grad3[12] = {{1,1,0},{-1,1,0},{1,-1,0},{-1,-1,0},
...
//static double (*tfuncs[1])(double,double) = {noise};
static int32_t wtinit(CSOUND *csound, SIMPLEXTR *p)
{
    initPerm();
    p->theta = 0.0;
    return OK;
...
static int32_t wtPerf(CSOUND *csound, SIMPLEXTR *p)
{
...
static OENTRY localops[] = {
  { "simplexterrain", S(SIMPLEXTR), TR, 3,  "a", "kkkkkkkkk",
